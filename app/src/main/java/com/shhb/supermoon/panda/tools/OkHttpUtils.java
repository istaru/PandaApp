...
//        mOkHttpClient.newCall(request).enqueue(responseCallback);
     ...
     * @param json
     */
    public static void postEnqueue(String url, Callback responseCallback, String json) {
        //把请求的内容字符串转换为json
     ...
     * @param map
     */
    public static void postEnqueue(String url, Callback responseCallback, Map<String,String> map) {
        //把请求的内容字符串转换为json
